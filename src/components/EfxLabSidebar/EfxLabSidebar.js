...
import styles from './EfxLabSidebar.styles.css';
...
class EfxLabSidebar extends React.Component {
    constructor(props) {
        super(props);
...
export default connect(mapStateToProps)(EfxLabSidebar);

EfxLabSidebar.defaultProps = {};

EfxLabSidebar.propTypes = {
