...
(function(window, undefined) {
        ...
        jQuery.extend({
            ...
            each(object, callback, args) {
                ...
                if (args) {
                    ...
                    for (; i < length; ) {
                        if (
                            callback.call(object[i], i, object[i++]) === false
                        ) {
                            break;
                        }
                    }
        ...
        var Expr = (Sizzle.selectors = {
            ...
            filter: {
                ...
                CLASS(elem, match) {
                    return (
                        ` ${elem.className ||
                            elem.getAttribute('class')} `.indexOf(match) > -1
                    );
                },
                ...
                Sizzle = function(query, context, extra, seed) {
                    ...
                    if (!seed && !Sizzle.isXML(context)) {
                        ...
                        if (context.nodeType === 9) {
                            ...
                            const relativeHierarchySelector = /^\s*[+~]/.test(
                                query
                            );
        ...
        domManip(args, table, callback) {
            ...
            if (this[0]) {
                ...
                if (first) {
                    ...
                    for (
                        let i = 0, l = this.length, lastIndex = l - 1;
                        i < l;
                        i++
                    ) {
                        callback.call(
    ...
    function addToPrefiltersOrTransports(structure) {
        ...
        return function(dataTypeExpression, func) {
            ...
            if (jQuery.isFunction(func)) {
                const dataTypes = dataTypeExpression
                    .toLowerCase()
                    .split(rspacesAjax);
                let i = 0;
    ...
    jQuery.ajaxPrefilter('json jsonp', function(s, originalSettings, jqXHR) {
        ...
        if (
            ...
            const jsonpCallback = (s.jsonpCallback = jQuery.isFunction(
                s.jsonpCallback
            )
                ? s.jsonpCallback()
                : s.jsonpCallback);
    ...
    jQuery.fn.extend({
        position() {
            ...
            const parentOffset = rroot.test(offsetParent[0].nodeName)
                ? { top: 0, left: 0 }
                : offsetParent.offset();
